...
#-1 for phising or 1 for legitimate
...
def category1(url):
    ...
    file_obj = open(r'phishing5.txt','w') #file is opened and values according to each website portion are added to the file
    if match!=None:
